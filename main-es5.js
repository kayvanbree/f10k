...
var AppComponent = /** @class */ (function () {
    function AppComponent(spotifyAuthentication) {
...
/* harmony import */ var _ngxs_devtools_plugin__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @ngxs/devtools-plugin */ "./node_modules/@ngxs/devtools-plugin/fesm5/ngxs-devtools-plugin.js");
...
/* harmony import */ var _ngxs_storage_plugin__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @ngxs/storage-plugin */ "./node_modules/@ngxs/storage-plugin/fesm5/ngxs-storage-plugin.js");
...
var ArtistListComponent = /** @class */ (function () {
    function ArtistListComponent(router, store) {
        this.router = router;
        this.store = store;
    ...
    ArtistListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.updateItems();
        this.store.select(function (state) { return state.artists.artists; }).subscribe(function (value) {
            _this.artists = value;
            _this.loading = false;
        });
    };
    ArtistListComponent.prototype.ngOnChanges = function () {
        this.updateItems();
    };
    ArtistListComponent.prototype.openArtist = function (id) {
        this.router.navigate(['/artist', id]);
    };
    ArtistListComponent.prototype.openPage = function (event) {
        this.pageChange.emit(event.pageIndex);
    };
    ArtistListComponent.prototype.updateItems = function () {
        var start = this.pageSize * this.currentPage;
        var end = start + this.pageSize;
        var pageItems = this.ids.slice(start, end);
        this.store.dispatch(new _store_actions_artist_actions__WEBPACK_IMPORTED_MODULE_4__["GetArtists"](pageItems, this.pageSize));
    };
    ArtistListComponent.ctorParameters = function () { return [
...
var ArtistSaveButtonComponent = /** @class */ (function () {
    function ArtistSaveButtonComponent(store) {
        this.store = store;
    }
    ArtistSaveButtonComponent.prototype.ngOnChanges = function () {
        var _this = this;
        this.store.select(_store_states_artist_state__WEBPACK_IMPORTED_MODULE_3__["ArtistState"].isSaved(this.id)).subscribe(function (value) {
            _this.isSaved = value;
        });
    };
    ArtistSaveButtonComponent.prototype.save = function (event) {
        event.stopPropagation();
        this.store.dispatch(new _store_actions_artist_actions__WEBPACK_IMPORTED_MODULE_4__["SaveArtist"](this.id));
    };
    ArtistSaveButtonComponent.prototype.remove = function (event) {
        event.stopPropagation();
        this.store.dispatch(new _store_actions_artist_actions__WEBPACK_IMPORTED_MODULE_4__["RemoveArtist"](this.id));
    };
    ArtistSaveButtonComponent.ctorParameters = function () { return [
    ...
    return ArtistSaveButtonComponent;
}());
...
var PlaybackControlsComponent = /** @class */ (function () {
    function PlaybackControlsComponent(store) {
        this.store = store;
    }
    PlaybackControlsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.store.select(function (state) { return state.player; }).subscribe(function (value) {
            _this.player = value;
        });
    };
    PlaybackControlsComponent.prototype.togglePlay = function () {
        this.store.dispatch(new _store_actions_player_actions__WEBPACK_IMPORTED_MODULE_3__["TogglePlay"]());
    };
    PlaybackControlsComponent.prototype.next = function () {
        this.store.dispatch(new _store_actions_player_actions__WEBPACK_IMPORTED_MODULE_3__["NextTrack"]());
    };
    PlaybackControlsComponent.prototype.previous = function () {
        this.store.dispatch(new _store_actions_player_actions__WEBPACK_IMPORTED_MODULE_3__["PreviousTrack"]());
    };
    PlaybackControlsComponent.ctorParameters = function () { return [
        { type: _ngxs_store__WEBPACK_IMPORTED_MODULE_2__["Store"] }
    ]; };
...
var PlayerComponent = /** @class */ (function () {
    function PlayerComponent(store) {
        this.store = store;
    }
...
var PositionSliderComponent = /** @class */ (function () {
    function PositionSliderComponent(store) {
        this.store = store;
        this.sliding = false;
    }
    PositionSliderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.store.select(function (state) { return state.player; }).subscribe(function (value) {
            if (!_this.sliding) {
                _this.player = value;
    ...
    PositionSliderComponent.prototype.seekPosition = function (event) {
        if (this.sliding) {
            this.store.dispatch(new _store_actions_player_actions__WEBPACK_IMPORTED_MODULE_3__["Seek"](event.value));
            this.sliding = false;
        }
    };
    PositionSliderComponent.prototype.onInput = function (event) {
        this.sliding = true;
    };
    PositionSliderComponent.ctorParameters = function () { return [
        { type: _ngxs_store__WEBPACK_IMPORTED_MODULE_2__["Store"] }
    ]; };
    ...
    return PositionSliderComponent;
}());
...
var TrackListComponent = /** @class */ (function () {
    ...
    TrackListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.updateItems();
        this.store.select(function (state) { return state.tracks.tracks; }).subscribe(function (value) {
            _this.tracks = value;
            _this.loading = false;
        });
        this.store.select(function (state) { return state.player.current_track.id; }).subscribe(function (value) {
            _this.currentSongId = value;
        });
    };
    TrackListComponent.prototype.ngOnChanges = function () {
        this.updateItems();
    };
    TrackListComponent.prototype.playTrack = function (id) {
        this.store.dispatch(new _store_actions_player_actions__WEBPACK_IMPORTED_MODULE_3__["PlayTrack"](this.ids, id));
    };
    TrackListComponent.prototype.openPage = function (event) {
        this.pageChange.emit(event.pageIndex);
    };
    TrackListComponent.prototype.updateItems = function () {
        var start = this.pageSize * this.currentPage;
        var end = start + this.pageSize;
        var pageItems = this.ids.slice(start, end);
    ...
    TrackListComponent.ctorParameters = function () { return [
        { type: _ngxs_store__WEBPACK_IMPORTED_MODULE_2__["Store"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
var TrackSaveButtonComponent = /** @class */ (function () {
    function TrackSaveButtonComponent(store) {
        this.store = store;
    }
    TrackSaveButtonComponent.prototype.ngOnChanges = function () {
        var _this = this;
        this.store.select(_store_states_track_state__WEBPACK_IMPORTED_MODULE_3__["TrackState"].isSaved(this.id)).subscribe(function (value) {
            _this.isSaved = value;
        });
    };
    TrackSaveButtonComponent.prototype.save = function (event) {
        event.stopPropagation();
        this.store.dispatch(new _store_actions_track_actions__WEBPACK_IMPORTED_MODULE_4__["SaveTrack"](this.id));
    };
    TrackSaveButtonComponent.prototype.remove = function (event) {
        event.stopPropagation();
        this.store.dispatch(new _store_actions_track_actions__WEBPACK_IMPORTED_MODULE_4__["RemoveTrack"](this.id));
    };
    TrackSaveButtonComponent.ctorParameters = function () { return [
        { type: _ngxs_store__WEBPACK_IMPORTED_MODULE_2__["Store"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return TrackSaveButtonComponent;
}());
...
var VolumeControlComponent = /** @class */ (function () {
    function VolumeControlComponent(store) {
        this.store = store;
    }
    VolumeControlComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.store.select(function (state) { return state.player.device.volume_percent; }).subscribe(function (value) {
            _this.volume = value;
        });
    };
    VolumeControlComponent.prototype.onNgModelChange = function (volume) {
...
var SpotifyRedirectGuard = /** @class */ (function () {
    function SpotifyRedirectGuard(router) {
        this.router = router;
    }
    SpotifyRedirectGuard.prototype.canActivate = function (route, state) {
        var e_1, _a;
        var accessToken;
        var tokenType;
        var expiresIn;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](route.fragment.split('&')), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    SpotifyRedirectGuard.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var SpotifyGuard = /** @class */ (function () {
    function SpotifyGuard(router, player) {
        this.router = router;
        this.player = player;
    }
    SpotifyGuard.prototype.canActivate = function (route, state) {
        var _this = this;
        if (localStorage.getItem('ngx-spotify-token')) {
            window.waitForSpotify.then(function () {
                if (!_this.player.isInitialized()) {
    ...
    SpotifyGuard.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
var SpotifyAuthorizationInterceptor = /** @class */ (function () {
    function SpotifyAuthorizationInterceptor() {
    }
    SpotifyAuthorizationInterceptor.prototype.intercept = function (request, next) {
    ...
    return SpotifyAuthorizationInterceptor;
}());
...
var ArtistDetailComponent = /** @class */ (function () {
    function ArtistDetailComponent(store, route) {
        this.store = store;
        this.route = route;
    }
    ArtistDetailComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (value) {
            _this.store.dispatch(new _store_actions_artist_actions__WEBPACK_IMPORTED_MODULE_4__["GetArtist"](value.id));
        });
        this.store.select(function (state) { return state.artists.currentArtist; }).subscribe(function (value) {
            _this.artist = value;
        });
    };
    ArtistDetailComponent.ctorParameters = function () { return [
        { type: _ngxs_store__WEBPACK_IMPORTED_MODULE_2__["Store"] },
...
var ArtistsComponent = /** @class */ (function () {
    function ArtistsComponent(store) {
        this.store = store;
        this.pageSize = 50;
    }
    ArtistsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.store.select(function (state) { return state.artists.ids; }).subscribe(function (value) {
            _this.ids = value;
        });
    };
    ArtistsComponent.prototype.onPageChange = function (offset) {
        var start = offset * this.pageSize;
        var end = start + this.pageSize;
        var pageIds = this.ids.slice(start, end);
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.profileService.getProfile().subscribe(function (value) {
            _this.profile = value;
        });
    };
...
var ImportComponent = /** @class */ (function () {
    function ImportComponent(store) {
        this.store = store;
    }
    ...
    ImportComponent.prototype.startImportFromPlaylists = function () {
...
var LoginPageComponent = /** @class */ (function () {
    function LoginPageComponent(spotifyAuthentication) {
        this.spotifyAuthentication = spotifyAuthentication;
    }
...
var SearchPageComponent = /** @class */ (function () {
    function SearchPageComponent(route, store) {
        this.route = route;
        this.store = store;
        this.pageSize = 10;
    ...
    SearchPageComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.queryParams.subscribe(function (value) {
            _this.query = value.query;
            _this.store.dispatch(new _store_actions_search_actions__WEBPACK_IMPORTED_MODULE_4__["Search"](_this.query, _this.pageSize, 0, [
                'album',
                'artist',
                'track',
                'playlist',
        ...
        this.store.select(function (state) { return state.search.results; }).subscribe(function (value) {
            if (value) {
                if (value.tracks) {
                    _this.trackResults = value.tracks;
                    _this.trackIds = value.tracks.items.map(function (x) { return x.id; });
                    _this.trackTotal = value.tracks.total;
                }
                if (value.artists) {
                    _this.artistResults = value.artists;
                    _this.artistIds = value.artists.items.map(function (x) { return x.id; });
                    _this.artistTotal = value.artists.total;
                }
            }
        });
    };
    SearchPageComponent.prototype.onPageChange = function (offset, type) {
...
var TracksComponent = /** @class */ (function () {
    function TracksComponent(store) {
        this.store = store;
        this.pageSize = 50;
    }
    TracksComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.store.select(function (state) { return state.tracks.ids; }).subscribe(function (value) {
            _this.ids = value;
        });
    };
    TracksComponent.prototype.onPageChange = function (offset) {
        var start = offset * this.pageSize;
        var end = start + this.pageSize;
        var pageIds = this.ids.slice(start, end);
...
var MinutesSecondsPipe = /** @class */ (function () {
    ...
    MinutesSecondsPipe.prototype.transform = function (value) {
        var seconds = value / 1000;
        var minutes = Math.floor(seconds / 60);
        return minutes + ':' + this.pad(Math.floor(seconds - minutes * 60), 2);
    };
    MinutesSecondsPipe.prototype.pad = function (num, size) {
        var s = num + '';
        while (s.length < size) {
            s = '0' + s;
        }
...
var SpotifyAuthenticationService = /** @class */ (function () {
    function SpotifyAuthenticationService(config) {
        this.config = config;
    }
    SpotifyAuthenticationService_1 = SpotifyAuthenticationService;
    SpotifyAuthenticationService.prototype.getToken = function () {
        return localStorage.getItem(SpotifyAuthenticationService_1.tokenKey);
    };
    SpotifyAuthenticationService.prototype.isLoggedIn = function () {
        return !!localStorage.getItem(SpotifyAuthenticationService_1.tokenKey);
    };
    SpotifyAuthenticationService.prototype.login = function () {
        var params = {
    ...
    SpotifyAuthenticationService.prototype.toQueryString = function (obj) {
        var parts = [];
        for (var key in obj) {
    ...
    SpotifyAuthenticationService.ctorParameters = function () { return [
...
var GetArtists = /** @class */ (function () {
    function GetArtists(ids, pageSize) {
        this.ids = ids;
        this.pageSize = pageSize;
    }
    GetArtists.type = '[Artist] GetArtists';
    GetArtists.ctorParameters = function () { return [
        { type: Array },
        { type: Number }
    ]; };
    return GetArtists;
...
var GetArtistsSuccess = /** @class */ (function () {
    function GetArtistsSuccess(artists) {
        this.artists = artists;
    }
    GetArtistsSuccess.type = '[Artist] GetArtistsSuccess';
    GetArtistsSuccess.ctorParameters = function () { return [
        { type: Array }
    ]; };
    return GetArtistsSuccess;
}());

var GetArtist = /** @class */ (function () {
    function GetArtist(id) {
        this.id = id;
    }
    GetArtist.type = '[Artist] GetArtist';
    GetArtist.ctorParameters = function () { return [
        { type: String }
    ]; };
    return GetArtist;
}());

var GetArtistSuccess = /** @class */ (function () {
    function GetArtistSuccess(artist) {
        this.artist = artist;
    }
    GetArtistSuccess.type = '[Artist] GetArtistSuccess';
    GetArtistSuccess.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return GetArtistSuccess;
}());

var SaveArtist = /** @class */ (function () {
    function SaveArtist(id) {
        this.id = id;
    }
    SaveArtist.type = '[Artist] SaveArtist';
    SaveArtist.ctorParameters = function () { return [
        { type: String }
    ]; };
    return SaveArtist;
}());

var RemoveArtist = /** @class */ (function () {
    function RemoveArtist(id) {
        this.id = id;
    }
    RemoveArtist.type = '[Artist] RemoveArtist';
    RemoveArtist.ctorParameters = function () { return [
        { type: String }
    ]; };
    return RemoveArtist;
}());
...
var PlayTrack = /** @class */ (function () {
    function PlayTrack(ids, id) {
        this.ids = ids;
        this.id = id;
    }
    PlayTrack.type = '[Player] PlayTrack';
    PlayTrack.ctorParameters = function () { return [
        { type: Array },
        { type: String }
    ]; };
    return PlayTrack;
...
var UpdatePlayerStatus = /** @class */ (function () {
    function UpdatePlayerStatus(currentTrack, duration, position, paused) {
    ...
    UpdatePlayerStatus.ctorParameters = function () { return [
        { type: undefined },
        { type: Number },
        { type: Number },
        { type: Boolean }
...
var RegisterPlayer = /** @class */ (function () {
    function RegisterPlayer(deviceId) {
        this.deviceId = deviceId;
    }
    RegisterPlayer.type = '[Player] RegisterPlayer';
    RegisterPlayer.ctorParameters = function () { return [
        { type: String }
    ]; };
    return RegisterPlayer;
}());

var TogglePlay = /** @class */ (function () {
    function TogglePlay() {
    }
...
var PreviousTrack = /** @class */ (function () {
...
var UpdateVolume = /** @class */ (function () {
    function UpdateVolume(volume) {
        this.volume = volume;
    }
    UpdateVolume.type = '[Player] UpdateVolume';
    UpdateVolume.ctorParameters = function () { return [
        { type: Number }
    ]; };
    return UpdateVolume;
}());

var SetVolume = /** @class */ (function () {
    function SetVolume(volume) {
        this.volume = volume;
    }
    SetVolume.type = '[Player] SetVolume';
    SetVolume.ctorParameters = function () { return [
        { type: Number }
    ]; };
    return SetVolume;
}());

var UpdateDeviceStatus = /** @class */ (function () {
    function UpdateDeviceStatus(device) {
        this.device = device;
    }
    UpdateDeviceStatus.type = '[Player] UpdateDeviceStatus';
    UpdateDeviceStatus.ctorParameters = function () { return [
        { type: undefined }
    ]; };
...
var Seek = /** @class */ (function () {
    ...
    Seek.ctorParameters = function () { return [
        { type: Number }
    ]; };
    return Seek;
}());
...
var Search = /** @class */ (function () {
    function Search(query, pageSize, offset, type) {
        this.query = query;
        this.pageSize = pageSize;
        this.offset = offset;
        this.type = type;
...
var SearchSuccess = /** @class */ (function () {
    ...
    SearchSuccess.ctorParameters = function () { return [
        { type: undefined }
    ]; };
...
var GetTracks = /** @class */ (function () {
    function GetTracks(ids, pageSize) {
        this.ids = ids;
        this.pageSize = pageSize;
    }
    GetTracks.type = '[Track] GetTracks';
    GetTracks.ctorParameters = function () { return [
        { type: Array },
        { type: Number }
    ]; };
    return GetTracks;
...
var GetTracksSuccess = /** @class */ (function () {
    function GetTracksSuccess(tracks) {
        this.tracks = tracks;
    }
    GetTracksSuccess.type = '[Track] GetTracksSuccess';
    GetTracksSuccess.ctorParameters = function () { return [
        { type: Array }
    ]; };
    return GetTracksSuccess;
}());

var SaveTrack = /** @class */ (function () {
    function SaveTrack(id) {
        this.id = id;
    }
    SaveTrack.type = '[Track] SaveTrack';
    SaveTrack.ctorParameters = function () { return [
        { type: String }
    ]; };
    return SaveTrack;
}());

var RemoveTrack = /** @class */ (function () {
    function RemoveTrack(id) {
        this.id = id;
    }
    RemoveTrack.type = '[Track] RemoveTrack';
    RemoveTrack.ctorParameters = function () { return [
        { type: String }
    ]; };
    return RemoveTrack;
}());

var ImportTracks = /** @class */ (function () {
    function ImportTracks(offset) {
        this.offset = offset;
    }
    ImportTracks.type = '[Track] ImportTracks';
    ImportTracks.ctorParameters = function () { return [
        { type: Number }
    ]; };
    return ImportTracks;
}());

var ImportTracksSuccess = /** @class */ (function () {
    function ImportTracksSuccess(importObject) {
        this.importObject = importObject;
    }
    ImportTracksSuccess.type = '[Track] ImportTracksSuccess';
    ImportTracksSuccess.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return ImportTracksSuccess;
}());

var ImportPlaylists = /** @class */ (function () {
    function ImportPlaylists(offset) {
        this.offset = offset;
    }
    ImportPlaylists.type = '[Track] ImportPlaylists';
    ImportPlaylists.ctorParameters = function () { return [
        { type: Number }
    ]; };
    return ImportPlaylists;
}());

var ImportPlaylistsSuccess = /** @class */ (function () {
    function ImportPlaylistsSuccess(importObject) {
        this.importObject = importObject;
    }
    ImportPlaylistsSuccess.type = '[Track] ImportPlaylistsSuccess';
    ImportPlaylistsSuccess.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return ImportPlaylistsSuccess;
}());

var ImportTracksFromPlaylist = /** @class */ (function () {
    function ImportTracksFromPlaylist(id, offset) {
        this.id = id;
        this.offset = offset;
    }
    ImportTracksFromPlaylist.type = '[Track] ImportTracksFromPlaylist';
    ImportTracksFromPlaylist.ctorParameters = function () { return [
        { type: Number },
        { type: Number }
    ]; };
    return ImportTracksFromPlaylist;
}());

var ImportTracksFromPlaylistSuccess = /** @class */ (function () {
    function ImportTracksFromPlaylistSuccess(id, importObject) {
        this.id = id;
        this.importObject = importObject;
    }
    ImportTracksFromPlaylistSuccess.type = '[Track] ImportTracksFromPlaylistSuccess';
    ImportTracksFromPlaylistSuccess.ctorParameters = function () { return [
        { type: Number },
        { type: undefined }
    ]; };
    return ImportTracksFromPlaylistSuccess;
}());
...
var AlbumSpotifyService = /** @class */ (function () {
    function AlbumSpotifyService(config, http) {
        this.config = config;
        this.http = http;
    }
    AlbumSpotifyService.prototype.getAlbums = function () {
        return this.http.get(this.config.apiBase + "/albums");
    };
    AlbumSpotifyService.prototype.getAlbum = function (album) {
        return this.http.get(this.config.apiBase + "/albums/" + album);
    };
    AlbumSpotifyService.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: ['SpotifyConfig',] }] },
...
var ArtistSpotifyService = /** @class */ (function () {
    function ArtistSpotifyService(config, http) {
        this.config = config;
        this.http = http;
    }
    ArtistSpotifyService.prototype.getArtist = function (id) {
        return this.http.get(this.config.apiBase + "/artists/" + id);
    };
    ArtistSpotifyService.prototype.getArtists = function (ids, pageSize) {
        var artists = ids.slice(0, Math.min(pageSize, ids.length)).join();
        return this.http.get(this.config.apiBase + "/artists?ids=" + artists);
    };
    ArtistSpotifyService.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: ['SpotifyConfig',] }] },
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var PlayerSpotifyService = /** @class */ (function () {
    function PlayerSpotifyService(config, http, spotifyAuthenticationService, store) {
        this.config = config;
        this.http = http;
    ...
    PlayerSpotifyService.prototype.isInitialized = function () {
        return this.initialized;
    };
    PlayerSpotifyService.prototype.initialize = function () {
        var _this = this;
        console.log('Spotify Web Playback SDK is ready');
        this.player = new window.Spotify.Player({
            name: 'f10k',
            getOAuthToken: function (callback) {
                callback(_this.spotifyAuthenticationService.getToken());
            },
            volume: 0.2
        });
        ...
        this.player.addListener('ready', function (data) {
            console.log('The Web Playback SDK is ready to play music!');
        });
        this.player.addListener('not_ready', function (_a) {
        ...
        this.player.on('ready', function (data) {
            ...
            if (!_this.playerRegistered) {
                _this.store.dispatch(new _actions_player_actions__WEBPACK_IMPORTED_MODULE_4__["RegisterPlayer"](device_id));
                _this.playerRegistered = true;
            }
        });
        this.player.on('not_ready', function (data) {
            var device_id = data.device_id;
            console.log('Connected with Device ID', device_id);
        });
        this.player.addListener('initialization_error', function (e) {
            console.error('Failed to initialize', e.message);
        });
        this.player.addListener('authentication_error', function (e) {
            console.error('Failed to authenticate', e.message);
        });
        this.player.addListener('account_error', function (e) {
            console.error('Failed to validate Spotify account', e.message);
        });
        this.player.addListener('playback_error', function (e) {
            console.error('Failed to perform playback', e.message);
        });
        this.player.on('player_state_changed', function (playbackState) {
            _this.store.dispatch(new _actions_player_actions__WEBPACK_IMPORTED_MODULE_4__["UpdatePlayerStatus"](playbackState.track_window.current_track, playbackState.duration, playbackState.position, playbackState.paused));
        });
        setInterval(function () {
            _this.getDeviceChanges();
            // this.getStateChanges();
            _this.getTrackChanges();
        }, 1000);
        this.initialized = true;
    };
    PlayerSpotifyService.prototype.getStateChanges = function () {
        var _this = this;
        this.player.getCurrentState().then(function (playbackState) {
            if (playbackState) {
                _this.store.dispatch(new _actions_player_actions__WEBPACK_IMPORTED_MODULE_4__["UpdatePlayerStatus"](playbackState.track_window ? playbackState.track_window.current_track : null, playbackState.duration, playbackState.position, playbackState.paused));
            }
        });
    };
    PlayerSpotifyService.prototype.getTrackChanges = function () {
        var _this = this;
        this.http.get(this.config.apiBase + "/me/player/currently-playing").subscribe(function (value) {
            if (value) {
                _this.store.dispatch(new _actions_player_actions__WEBPACK_IMPORTED_MODULE_4__["UpdatePlayerStatus"](value.item, value.item.duration_ms, value.progress_ms, !value.is_playing));
            }
        });
    };
    PlayerSpotifyService.prototype.getDeviceChanges = function () {
        var _this = this;
        this.http.get(this.config.apiBase + "/me/player").subscribe(function (value) {
            if (value && value.device) {
                _this.store.dispatch(new _actions_player_actions__WEBPACK_IMPORTED_MODULE_4__["UpdateDeviceStatus"](value.device));
            }
        });
    };
    PlayerSpotifyService.prototype.playTrack = function (ids, id, deviceId, current) {
        var url = this.config.apiBase + "/me/player/play";
        // url += current ? '' : '?device_id=' + deviceId;
        url += '?device_id=' + deviceId;
        var index = ids.findIndex(function (x) { return x === id; });
        var queue = ids.slice(index, Math.min(index + 50, ids.length)).map(function (x) { return "spotify:track:" + x; });
        return this.http.put(url, {
            uris: queue,
        });
    };
    PlayerSpotifyService.prototype.togglePlay = function () {
        this.player.togglePlay();
    };
    PlayerSpotifyService.prototype.next = function (device) {
        return this.http.post(this.config.apiBase + "/me/player/next", {});
    };
    PlayerSpotifyService.prototype.previous = function (device) {
        return this.http.post(this.config.apiBase + "/me/player/previous", {});
    };
    PlayerSpotifyService.prototype.setVolume = function (device, volume) {
        return this.http.put(" " + this.config.apiBase + "/me/player/volume?device_id=" + device + "&volume_percent=" + volume, {});
    };
    PlayerSpotifyService.prototype.seek = function (device, position) {
        return this.http.put(" " + this.config.apiBase + "/me/player/seek?device_id=" + device + "&position_ms=" + position, {});
    };
    PlayerSpotifyService.prototype.disconnect = function () {
        this.player.disconnect();
    };
    PlayerSpotifyService.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: ['SpotifyConfig',] }] },
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
...
var PlaylistSpotifyService = /** @class */ (function () {
    function PlaylistSpotifyService(config, http) {
        this.config = config;
        this.http = http;
    }
    PlaylistSpotifyService.prototype.getPlaylists = function () {
        return this.http.get(this.config.apiBase + "/me/playlists");
    };
    PlaylistSpotifyService.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: ['SpotifyConfig',] }] },
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var ProfileSpotifyService = /** @class */ (function () {
    function ProfileSpotifyService(config, http) {
        this.config = config;
        this.http = http;
    }
    ProfileSpotifyService.prototype.getProfile = function () {
        return this.http.get(this.config.apiBase + "/me");
    };
    ProfileSpotifyService.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: ['SpotifyConfig',] }] },
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var SearchSpotifyService = /** @class */ (function () {
    function SearchSpotifyService(config, http) {
        this.config = config;
        this.http = http;
    }
    SearchSpotifyService.prototype.search = function (query, limit, offset, type) {
        return this.http.get(this.config.apiBase + "/search?q=" + query + "&type=" + type + "&market=from_token&limit=" + limit + "&offset=" + offset);
    };
    SearchSpotifyService.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: ['SpotifyConfig',] }] },
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var TrackSpotifyService = /** @class */ (function () {
    function TrackSpotifyService(config, http) {
        this.config = config;
        this.http = http;
    }
    TrackSpotifyService.prototype.getTrack = function (id) {
        return this.http.get(this.config.apiBase + "/track/" + id);
    };
    TrackSpotifyService.prototype.getTracks = function (ids, pageSize) {
        var tracks = ids.slice(0, Math.min(pageSize, ids.length)).join();
        return this.http.get(this.config.apiBase + "/tracks?ids=" + tracks);
    };
    TrackSpotifyService.prototype.importTracks = function (offset) {
        var url = this.config.apiBase + "/me/tracks?limit=50";
        if (offset > 0) {
            url += "&offset=" + offset;
        }
        return this.http.get(url);
    };
    TrackSpotifyService.prototype.importPlaylists = function (offset) {
        var url = this.config.apiBase + "/me/playlists?limit=50";
        if (offset > 0) {
            url += "&offset=" + offset;
        }
        return this.http.get(url);
    };
    TrackSpotifyService.prototype.importTracksFromPlaylists = function (id, offset) {
        var url = this.config.apiBase + "/playlists/" + id + "/tracks?limit=50";
        if (offset > 0) {
            url += "&offset=" + offset;
        }
        return this.http.get(url);
    };
    TrackSpotifyService.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: ['SpotifyConfig',] }] },
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
/* harmony import */ var _ngxs_store_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ngxs/store/operators */ "./node_modules/@ngxs/store/fesm5/ngxs-store-operators.js");
...
var ArtistState = /** @class */ (function () {
    function ArtistState(artistService) {
        this.artistService = artistService;
    }
    ArtistState_1 = ArtistState;
    ArtistState.isSaved = function (id) {
        return Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])([ArtistState_1], function (state) {
            return state.ids.filter(function (s) { return s === id; }).length > 0;
        });
    };
    ArtistState.prototype.getArtists = function (ctx, action) {
        this.artistService.getArtists(action.ids, action.pageSize).subscribe(function (value) {
            ctx.dispatch(new _actions_artist_actions__WEBPACK_IMPORTED_MODULE_2__["GetArtistsSuccess"](value.artists));
        });
    };
    ArtistState.prototype.getArtistsSuccess = function (ctx, action) {
        ctx.setState(Object(_ngxs_store_operators__WEBPACK_IMPORTED_MODULE_3__["patch"])({
            artists: action.artists,
        }));
    };
    ArtistState.prototype.getArtist = function (ctx, action) {
        var state = ctx.getState();
        ctx.patchState(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { currentArtistId: action.id }));
        this.artistService.getArtist(action.id).subscribe(function (value) {
            ctx.dispatch(new _actions_artist_actions__WEBPACK_IMPORTED_MODULE_2__["GetArtistSuccess"](value));
        });
    };
    ArtistState.prototype.getArtistSuccess = function (ctx, action) {
        var state = ctx.getState();
        ctx.patchState(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { currentArtist: action.artist }));
    };
    ArtistState.prototype.saveArtist = function (ctx, action) {
        ctx.setState(Object(_ngxs_store_operators__WEBPACK_IMPORTED_MODULE_3__["patch"])({
            ids: Object(_ngxs_store_operators__WEBPACK_IMPORTED_MODULE_3__["append"])([action.id]),
        }));
    };
    ArtistState.prototype.removeArtist = function (ctx, action) {
        ctx.setState(Object(_ngxs_store_operators__WEBPACK_IMPORTED_MODULE_3__["patch"])({
            ids: Object(_ngxs_store_operators__WEBPACK_IMPORTED_MODULE_3__["removeItem"])(function (name) { return name === action.id; }),
        }));
    };
    var ArtistState_1;
    ArtistState.ctorParameters = function () { return [
...
var FolderState = /** @class */ (function () {
    function FolderState() {
    }
    FolderState.folders = function (state) {
...
var PlayerState = /** @class */ (function () {
    function PlayerState(playerService) {
        this.playerService = playerService;
    }
    PlayerState.prototype.playTrack = function (ctx, action) {
        var state = ctx.getState();
        ctx.setState(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { track_list: action.ids, current_track_id: action.id }));
        this.playerService.playTrack(action.ids, action.id, state.device.id, !!state.initialized).subscribe();
    };
    PlayerState.prototype.togglePlay = function (ctx, action) {
        this.playerService.togglePlay();
    };
    PlayerState.prototype.updatePlayerStatus = function (ctx, action) {
        var state = ctx.getState();
        ctx.setState(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { current_track: action.currentTrack, duration: action.duration, position: action.position, paused: action.paused }));
    };
    PlayerState.prototype.registerPlayer = function (ctx, action) {
        var state = ctx.getState();
        ctx.setState(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { device: tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state.device, { id: action.deviceId }) }));
    };
    PlayerState.prototype.nextTrack = function (ctx, action) {
        var state = ctx.getState();
        this.playerService.next(state.device.id).subscribe();
    };
    PlayerState.prototype.previousTrack = function (ctx, action) {
        var state = ctx.getState();
        this.playerService.previous(state.device.id).subscribe();
    };
    PlayerState.prototype.setVolume = function (ctx, action) {
        var state = ctx.getState();
        this.playerService.setVolume(state.device.id, action.volume).subscribe();
    };
    PlayerState.prototype.updateDeviceStatus = function (ctx, action) {
        ctx.patchState({
            device: action.device,
        });
    };
    PlayerState.prototype.skipToPosition = function (ctx, action) {
        var state = ctx.getState();
        this.playerService.seek(state.device.id, action.position).subscribe();
    };
    PlayerState.ctorParameters = function () { return [
...
var SearchState = /** @class */ (function () {
    function SearchState(searchService) {
        this.searchService = searchService;
    }
    SearchState.prototype.search = function (ctx, action) {
        var state = ctx.getState();
        ctx.patchState(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { query: action.query }));
        this.searchService.search(action.query, action.pageSize, action.offset, action.type).subscribe(function (value) {
            ctx.dispatch(new _actions_search_actions__WEBPACK_IMPORTED_MODULE_2__["SearchSuccess"](value));
        });
    };
    SearchState.prototype.searchSuccess = function (ctx, action) {
        var state = ctx.getState();
        ctx.patchState(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { results: action.results }));
    };
...
var TrackState = /** @class */ (function () {
    function TrackState(trackService) {
        this.trackService = trackService;
    }
    TrackState_1 = TrackState;
    TrackState.isSaved = function (id) {
        return Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])([TrackState_1], function (state) {
            return state.ids.filter(function (s) { return s === id; }).length > 0;
        });
    };
    TrackState.prototype.getTracks = function (ctx, action) {
        this.trackService.getTracks(action.ids, action.pageSize).subscribe(function (value) {
            ctx.dispatch(new _actions_track_actions__WEBPACK_IMPORTED_MODULE_4__["GetTracksSuccess"](value.tracks));
        });
    };
    TrackState.prototype.getTracksSuccess = function (ctx, action) {
        ctx.setState(Object(_ngxs_store_operators__WEBPACK_IMPORTED_MODULE_3__["patch"])({
            tracks: action.tracks,
        }));
    };
    TrackState.prototype.saveTrack = function (ctx, action) {
        ctx.setState(Object(_ngxs_store_operators__WEBPACK_IMPORTED_MODULE_3__["patch"])({
            ids: Object(_ngxs_store_operators__WEBPACK_IMPORTED_MODULE_3__["append"])([action.id]),
        }));
    };
    TrackState.prototype.removeTrack = function (ctx, action) {
        ctx.setState(Object(_ngxs_store_operators__WEBPACK_IMPORTED_MODULE_3__["patch"])({
            ids: Object(_ngxs_store_operators__WEBPACK_IMPORTED_MODULE_3__["removeItem"])(function (name) { return name === action.id; }),
        }));
    };
    TrackState.prototype.importTracks = function (ctx, action) {
        this.trackService.importTracks(action.offset).subscribe(function (value) {
            console.log(value);
            ctx.dispatch(new _actions_track_actions__WEBPACK_IMPORTED_MODULE_4__["ImportTracksSuccess"](value));
        });
    };
    TrackState.prototype.importTracksSuccess = function (ctx, action) {
        var ids = action.importObject.items.map(function (x) { return x.track.id; });
        ctx.setState(Object(_ngxs_store_operators__WEBPACK_IMPORTED_MODULE_3__["patch"])({
    ...
    TrackState.prototype.importPlaylists = function (ctx, action) {
        this.trackService.importPlaylists(action.offset).subscribe(function (value) {
            ctx.dispatch(new _actions_track_actions__WEBPACK_IMPORTED_MODULE_4__["ImportPlaylistsSuccess"](value));
        });
    };
    TrackState.prototype.importPlaylistsSuccess = function (ctx, action) {
        var ids = action.importObject.items;
    ...
    TrackState.prototype.importFromPlaylistsTracks = function (ctx, action) {
        this.trackService.importTracksFromPlaylists(action.id, action.offset).subscribe(function (value) {
            ctx.dispatch(new _actions_track_actions__WEBPACK_IMPORTED_MODULE_4__["ImportTracksFromPlaylistSuccess"](action.id, value));
        });
    };
    TrackState.prototype.importTracksFromPlaylistsSuccess = function (ctx, action) {
        var ids = action.importObject.items.map(function (x) { return x.track.id; });
        ctx.setState(Object(_ngxs_store_operators__WEBPACK_IMPORTED_MODULE_3__["patch"])({
            ids: Object(_ngxs_store_operators__WEBPACK_IMPORTED_MODULE_3__["append"])(ids),
        }));
    ...
    var TrackState_1;
    TrackState.ctorParameters = function () { return [
